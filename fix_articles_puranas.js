...
function rewriteArticle() {
  let file = fs.readFileSync('frontend/src/pages/admin/articles/form.tsx', 'utf8');
  ...
  file = file.replace(/const \{ register, handleSubmit, watch, control, setValue, reset, formState: \{ errors, isDirty, isValid, defaultValues \} \} = useForm\(\{/, `const { register, handleSubmit, watch, control, setValue, reset, formState: { errors, isDirty, isValid, defaultValues, dirtyFields } } = useForm({`);
  ...
  const engBlock = `</div>
                ...
                <div className={activeLanguage === 'translation' ? 'block space-y-6' : 'hidden'}>
                  <TranslationPanel
                    ...
                    sourceLang="hi"
                    targetLang="en"
                    hasTranslation={!!watch('title_en' as any) || !!watch('excerpt_en' as any) || !!watch('content_en' as any)}
                  ...
                  {!(!!watch('title_en' as any) || !!watch('excerpt_en' as any) || !!watch('content_en' as any)) ? (
                    <div className="bg-white rounded-md shadow-sm border border-gray-200 p-12 text-center">
                      ...
                      <p className="text-gray-500 mb-6 max-w-md mx-auto">No English translation has been generated yet.<br/>Generate an English version of this Article from the Hindi original.</p>
                    </div>
                  ) : (
                    <>
  ...
  file = file.replace(endOfLeftColRegex, engBlock);
  ...
  fs.writeFileSync('frontend/src/pages/admin/articles/form.tsx', file);
}
                ...
                <div className={activeLanguage === 'translation' ? 'block space-y-6' : 'hidden'}>
                  ...
                  {!(!!watch('title_en' as any) || !!watch('description_en' as any)) ? (
                    <div className="bg-white rounded-md shadow-sm border border-gray-200 p-12 text-center">
                      ...
                      <h3 className="text-xl font-bold text-gray-900 mb-2">English Translation</h3>
                      <p className="text-gray-500 mb-6 max-w-md mx-auto">No English translation has been generated yet.<br/>Generate an English version of this Puran from the Hindi original.</p>
                    </div>
                  ) : (
                    <>
                      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-md shadow-sm border border-blue-100 p-6 space-y-5">
