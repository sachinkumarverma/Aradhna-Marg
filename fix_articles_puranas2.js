...
function rewriteArticle() {
  ...
  // The last div before right column is the end of lg:col-span-2.
  // The div before that is the end of Advanced SEO.
  // We need to inject our stuff AFTER Advanced SEO, but BEFORE the end of lg:col-span-2.
