...
export class ArticleService {
  ...
  private async updateRelations(id: string, deities: any, festivals: any, tags: any, bhajans: any, related_articles: any) {
    ...
    if (related_articles) await articleRepository.updateJunctionTable('related_articles', id, 'related_id', related_articles);
  }
