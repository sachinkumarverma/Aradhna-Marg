...
class SeoController {
    async getOverview(req, res, next) {
        try {
            const overview = await seo_service_1.seoService.getOverview();
    ...
    async getIssues(req, res, next) {
        try {
            const issues = await seo_service_1.seoService.getIssues();
    ...
    async generateSitemap(req, res, next) {
        try {
            await seo_service_1.seoService.generateSitemap();
    ...
    async generateRobots(req, res, next) {
        try {
            await seo_service_1.seoService.generateRobots();
    ...
    async generateBulkSEO(req, res, next) {
        try {
            await seo_service_1.seoService.generateBulkSEO(req.body);
