...
exports.buildGenerateSeoUserPrompt = exports.generateSeoSystemPrompt = void 0;
exports.generateSeoSystemPrompt = `
...
`;
const buildGenerateSeoUserPrompt = (title, description, categoryName, godName) => {
    return `
Bhajan Details:
Title: ${title}
...
exports.buildGenerateSeoUserPrompt = buildGenerateSeoUserPrompt;
