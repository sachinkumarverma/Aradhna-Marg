                          ...
                          <button
                            ...
                            className={cn(
                              ...
                              !isPast &&
                                isDayToday &&
                                !isSelected &&
                                'bg-gray-100 font-bold text-saffron ring-1 ring-saffron/30',
                              !isPast &&
                                isSelected &&
                                'bg-saffron text-white font-bold shadow-md hover:bg-saffron/90 transform scale-110'
                            )}
                          >
                            {format(day, 'd')}
                          </button>
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          currentMonth.getMonth() === i
                            ? 'bg-saffron text-white font-bold shadow-md'
                            : 'text-gray-700 hover:bg-gray-100 font-medium border border-gray-100'
                        )}
                      >
                        {m.substring(0, 3)}
                      </button>
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            isActive
                              ? 'bg-saffron text-white font-bold shadow-md active-year'
