  ...
  return (
    <div className="flex-1 space-y-4">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-darkBrown">Deities</h1>
          
          <p className="text-gray-500 mt-1 text-sm">
            Manage deities, divine forms, and their metadata.
          </p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center py-20 bg-white rounded-xl border border-gray-100 shadow-sm mt-8">
        ...
        <h3 className="text-xl font-bold text-darkBrown mb-2">No Deities Found</h3>
        <p className="text-gray-500 mb-6 max-w-sm text-center">
          Get started by adding your first deity to the platform.
        </p>
