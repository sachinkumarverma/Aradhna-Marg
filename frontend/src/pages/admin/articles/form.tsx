...
export const AdminArticleForm = () => {
  ...
  const { register, handleSubmit, watch, control, setValue, reset, formState: { errors, isDirty, isValid, defaultValues, dirtyFields } } = useForm({
    mode: 'onChange',
    defaultValues: {
      title: '',
      slug: '',
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className={activeLanguage === 'translation' ? 'block space-y-6' : 'hidden'}>
                  <TranslationPanel
                    ...
                    originalContent={{
                      title: watch("title"), excerpt: watch("excerpt"), content: watch("content"), seo_title: watch("seo_title"), seo_description: watch("seo_description")
                    }}
