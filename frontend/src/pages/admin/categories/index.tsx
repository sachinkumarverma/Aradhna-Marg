                ...
                <tbody className="divide-y divide-gray-100">
                  {categories.map((category: any) => (
                    <tr key={category.id} className="hover:bg-gray-50/50 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex flex-col gap-1">
                          <div className="flex items-center gap-2">
                            {(() => {
                              const IconComponent =
                                category.iconUrl && IconMap[category.iconUrl] ? IconMap[category.iconUrl] : FolderTree;
                          ...
                          {category.description && (
                            <p className="text-xs text-gray-500 truncate max-w-[300px] ml-6">{category.description}</p>
                          )}
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4 font-semibold text-gray-900 text-center">{category.bhajanCount}</td>
                      <td className="px-6 py-4 font-semibold text-gray-900 text-center">{category.displayOrder}</td>
                          ...
                          <label className="flex items-start gap-3 cursor-pointer group">
                            <div className="flex items-center h-5 mt-0.5">
                              <input
                                ...
                                className="w-4 h-4 text-saffron rounded border-gray-300 focus:ring-saffron cursor-pointer"
                              />
                            </div>
                            <div>
                              <p className="text-sm font-semibold text-gray-900 group-hover:text-saffron transition-colors">
                                Show in Navigation
                              </p>
