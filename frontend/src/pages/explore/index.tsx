  ...
  return (
    <div className="w-full min-h-screen bg-[#F9F7F3] pb-20">
      ...
      <div className="mt-8 space-y-12">
        ...
        <CollectionCarousel title="Popular Deities" items={gods} type="god" />

        {/* Trending Bhajans Carousel */}
        <BhajanCarousel title="Trending Today" items={mockBhajans} onViewAll={() => console.log('View all trending')} />

        {/* Categories Collection */}
        <CollectionCarousel title="Browse by Category" items={categories} type="category" />

        {/* Morning Specials Carousel */}
        <BhajanCarousel title="Morning Specials" items={[...mockBhajans].reverse()} />
        ...
        <BhajanCarousel title="Peaceful Evening Aartis" items={mockBhajans} />
      </div>
    </div>
  );
};
